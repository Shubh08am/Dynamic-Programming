...
int solve2(int ind,int N, vector<int> &price,vector<vector<int>>&dp){
    int n = price.size();
     if(ind==0){     
         //Taking rodLength of 1 N times gives total length as N
        //total prices will be N*price[0] 
...
int tabulationWithSpaceOptimization(int N, vector<int> &price){
    int n = price.size();
...
int tabulationWithSpaceOptimization2(int N, vector<int> &price){
     int n = price.size();
